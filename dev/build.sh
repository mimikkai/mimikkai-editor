...
export APP_NAME="MimikkAI Editor"
export ASSETS_REPOSITORY="mimikkai/mimikkai-editor"
export BINARY_NAME="mimikkai-editor"
export CI_BUILD="no"
export GH_REPO_PATH="mimikkai/mimikkai-editor"
export ORG_NAME="mimikkai"
...
while getopts ":ilops" opt; do
  case "$opt" in
    i)
      export ASSETS_REPOSITORY="mimikkai/mimikkai-editor-insiders"
      export BINARY_NAME="mimikkai-editor-insiders"
