...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/mimikkai/versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/mimikkai/mimikkai-editor-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/mimikkai/mimikkai-editor/releases"
fi
