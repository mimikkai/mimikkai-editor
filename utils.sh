...
APP_NAME="${APP_NAME:-MimikkAI Editor}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-mimikkai/mimikkai-editor}"
BINARY_NAME="${BINARY_NAME:-mimikkai-editor}"
GH_REPO_PATH="${GH_REPO_PATH:-mimikkai/mimikkai-editor}"
ORG_NAME="${ORG_NAME:-mimikkai}"
